...
class Alertas
{
    private $valid_type = [];//validar tipos de errores


    private $default = null;//notificaciones
    private $type = null;//tipo
    private $msg = null;//mensaje 
    ...
    public static function new($msg, $type = null)//funcion de ALERTA
    {
        $self = new self();
